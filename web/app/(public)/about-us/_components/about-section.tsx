...
const AboutSection = () => {
  return (
    <div className="bg-[#0a0a0a] text-[#f5f5f5] mt-10 antialiased font-sans overflow-hidden">
            ...
            <div className="space-y-6 max-w-xl">
              ...
              <div className="space-y-4 text-neutral-400 text-sm md:text-base leading-relaxed font-normal">
                <p>
                  ...
                  theater. We believe that every story deserves to be told in
                  its purest form, without compromise. In an era of fragmented
                  streaming, we created a sanctuary for storytelling—a place
                  where the frame vanishes and the film breathes.
                </p>
                <p>
      ...
      <Container>
        <section className="py-8 md:py-12  text-center border-t border-neutral-900">
      ...
      <Container>
        <section className="pb-12 md:pb-20 pt:8 md:pt-12">
