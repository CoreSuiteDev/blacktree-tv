        ...
        <CardContent className="flex flex-col items-center gap-8">
          ...
          >
            ...
            <Button
              ...
              className="h-12 w-full rounded-lg bg-primary text-sm font-bold uppercase tracking-wider text-white transition-all hover:bg-primary/90 hover:shadow-[0_0_20px_rgba(229,9,20,0.2)] cursor-pointer"
            >
              Verify & Access
            </Button>
          </form>
