...
const SubscriptionSection = () => {
  return (
    <div className="text-foreground flex items-center py-10 md:py-20 px-4">
      {/* Container - Using popover variable from your CSS */}
      <div className="container mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-10 items-center bg-popover p-6 md:p-12 lg:p-16 rounded-[30px] md:rounded-[40px] border border-white/5 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
        ...
        {/* Right Side: Card - Using Shadcn Card structure with your theme */}
        <div className="flex justify-center md:justify-end w-full">
          <div className="relative group w-full md:max-w-md">
            {/* The Glow Effect using your Primary Color */}
            <div className="absolute -inset-1 bg-gradient-to-tr from-primary/30 to-transparent blur-3xl opacity-60 rounded-[30px]"></div>

            <Card className="relative bg-card/90 border-border backdrop-blur-md rounded-[30px] shadow-2xl overflow-hidden">
              <CardContent className="p-6 sm:p-10 flex flex-col h-full">
                <div className="flex justify-between items-center mb-6">
                  <span className="text-muted-foreground font-bold tracking-widest text-[10px] lg:text-sm uppercase">
                    Premium Plan
                  </span>
                  <span className="bg-primary/10 text-primary text-[9px] lg:text-[10px] font-bold px-2 lg:px-3 py-1 rounded-full border border-primary/20 uppercase">
                    Most Popular
                  </span>
                </div>
                ...
                <div className="mb-6 lg:mb-10">
                  <div className="flex items-baseline">
                    <span className="text-4xl sm:text-5xl lg:text-6xl font-bold text-card-foreground">
                      $14.99
                    </span>
                ...
                <ul className="space-y-4 lg:space-y-6 mb-8 lg:mb-12">
                  <li className="flex items-center gap-3 text-sm lg:text-base">
                    <div className="bg-primary rounded-full p-0.5">
                      <Check
                        size={12}
                        className="text-primary-foreground lg:w-[14px]"
                        strokeWidth={4}
                      />
                    </div>
                ...
                <Button
                  variant="outline"
                  className="w-full border-border py-6 rounded-xl text-primary font-bold uppercase tracking-widest text-[10px] lg:text-sm hover:bg-accent transition-all"
                >
