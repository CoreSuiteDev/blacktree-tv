...
const SubscriptionSection = () => {
  ...
  return (
    <div className="text-foreground flex items-center py-10 md:py-12 px-4">
      <Container>
        <div className=" w-full grid grid-cols-1 md:grid-cols-2 gap-10 items-center bg-popover p-6 md:p-12 lg:p-16 rounded-[30px] md:rounded-[40px] border border-foreground/5 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
          <div className="space-y-6 lg:space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground  max-w-lg leading-relaxed">
                Unlock the highest fidelity viewing experience with 8K
                resolution, zero latency streaming, and exclusive access to
                Lumina Cinematic Originals.
              </p>
            </div>
            ...
            <div className="relative group w-full md:max-w-md">
              ...
              >
                <CardContent className="p-6 sm:p-10 flex flex-col h-full relative z-10">
                  ...
                  <Link
                    href={`/checkout/${premiumPlan.slug}`}
                    className="w-full"
                  >
                    <Button
                      variant="outline"
